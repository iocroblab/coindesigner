...
extern char const *qh_version; /* defined in global.c */
...
void 	qh_errprint(char const *string, facetT *atfacet, facetT *otherfacet, ridgeT *atridge, vertexT *atvertex);
...
void    qh_option (char const *option, int *i, realT *r);
#if qh_QHpointer
